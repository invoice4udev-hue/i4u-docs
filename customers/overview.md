...
Used as request body for create/update and returned by all retrieval endpoints. Inherits the [response envelope](../getting-started/welcome.md#response-envelope) (`Errors`, `Info`, `OpenInfo`).
